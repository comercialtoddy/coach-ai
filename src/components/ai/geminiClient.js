...
class GeminiClient {
    ...
    processResponse(rawResponse, options = {}) {
        ...
        // REMOVIDO: Limitação de tamanho - permitir respostas completas
        // Agora o HUD se adapta ao tamanho do texto
        ...
        // Retornar resposta completa sem truncamento
    ...
    async analyzeScreenshot(imageData, question = "") {
        try {
            ...
            return this.processResponse(response); // Sem limite de tamanho
